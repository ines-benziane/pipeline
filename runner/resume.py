...
def resume_pipeline(job_id, decision_status, output_dir, state, exam_id, segment, method_id, workdir, checkpoint, qc, source_dir, series, tag, comment):
    ...
    return run_job(job, output_dir, decision=decision)
